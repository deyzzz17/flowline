...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "tasks" ADD COLUMN "user_id" varchar NOT NULL;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "tasks_tags" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "tasks_subtasks" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "tasks_recurrence_days" DISABLE ROW LEVEL SECURITY;
