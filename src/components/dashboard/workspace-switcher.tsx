...
export function WorkspaceSwitcher({ planLabel }: WorkspaceSwitcherProps) {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          <WorkspaceAvatar className="size-6" />
          <span className="flex flex-1 flex-col items-start overflow-hidden text-left leading-tight">
            <span className="w-full truncate">Personal</span>
            {planLabel && (
...
export function SidebarWorkspaceSwitcher({ planLabel }: WorkspaceSwitcherProps) {
  return (
    <SidebarMenuItem>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <SidebarMenuButton size="lg" tooltip="Personal">
            ...
            <span className="grid flex-1 text-left leading-tight">
              ...
              {planLabel && <span className="truncate text-xs text-muted-foreground">{planLabel}</span>}
            </span>
