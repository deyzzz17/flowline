        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            className={cn(
              ...
              fieldErrors.name && 'border-destructive/50 focus-visible:ring-destructive/30',
            )}
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <Input
              ...
              className={cn(
                'h-10 rounded-xl border-border/60 bg-background pr-10 placeholder:text-muted-foreground/50 focus-visible:ring-violet-500/30',
                (fieldErrors.confirm || (confirmTouched && !passwordsMatch)) &&
          ...
          {confirmTouched && !fieldErrors.confirm && (
            <p
              className={cn(
                'flex items-center gap-1.5 text-xs animate-in fade-in',
