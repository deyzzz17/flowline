...
export const TasksContent = () => (
  <div>
    <p className="mb-1 text-[11px] font-bold uppercase tracking-wider text-blue-400">List</p>
    <div className="mb-3 flex items-center justify-between">
      <h3 className="text-lg font-bold text-white">Flowline</h3>
      <span className="text-[9px] text-white/30">5 active · 9 completed</span>
    </div>
      ...
      {['To do · 5', 'Achieved', 'Inactive', 'Trash'].map((t, i) => (
        <span
          ...
          className={`rounded-full px-2.5 py-1 text-[9px] font-medium ${
            i === 0 ? 'bg-white text-slate-900' : 'bg-white/5 text-white/35'
          }`}
        >
          {t}
        </span>
    ...
    <div className="space-y-1.5">
      ...
      <div className="rounded-lg border border-white/6 bg-white/[0.02] px-3 py-2">
        <div className="mb-1.5 flex items-center gap-2">
          ...
          <span className="ml-auto text-[9px] text-white/25">0/3</span>
        </div>
